...
import static co.runrightfast.vertx.orientdb.StandardFields.CREATED_ON;
import static co.runrightfast.vertx.orientdb.StandardFields.UPDATED_ON;
...
public class SetCreatedOnAndUpdatedOn extends ODocumentHookAbstract {
    ...
    private OClass timestampedRecord;
    ...
    public RESULT onRecordBeforeUpdate(final ODocument doc) {
        if (doc.getSchemaClass().isSubClassOf(timestampedRecord)) {
