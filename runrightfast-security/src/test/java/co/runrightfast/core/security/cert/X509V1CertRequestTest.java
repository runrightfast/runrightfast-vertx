 ...
 * @author alfio
 */
public class X509V1CertRequestTest {
    ...
    public void testHashCodeEquals() throws NoSuchAlgorithmException, NoSuchProviderException {
        ...
        final X509V1CertRequest request1 = new X509V1CertRequest(
                principal,
                BigInteger.ONE,
                Instant.now(),
        ...
        final X509V1CertRequest request2 = new X509V1CertRequest(
                principal,
                BigInteger.ONE,
                Instant.now(),
                Instant.ofEpochMilli(System.currentTimeMillis() + (10 * 1000)),
        ...
        final X509V1CertRequest request3 = new X509V1CertRequest(
                principal,
                BigInteger.TEN,
                Instant.now(),
                Instant.ofEpochMilli(System.currentTimeMillis() + (10 * 1000)),
        ...
        final X509V1CertRequest request4 = new X509V1CertRequest(
                principal,
                BigInteger.ONE,
                Instant.now(),
                Instant.ofEpochMilli(System.currentTimeMillis() + (10 * 1000)),
        ...
        final X509V1CertRequest request5 = new X509V1CertRequest(
                principal2,
                BigInteger.ONE,
                Instant.now(),
                Instant.ofEpochMilli(System.currentTimeMillis() + (10 * 1000)),
